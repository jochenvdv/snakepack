...
class SnakepackAcceptanceTest(BaseAcceptanceTest):
    ...
    def test_snakepack_as_application_with_all_transformers(self, cli_runner, tmp_path):
        ...
        dist_path = self._test_snakepack(config=config, cli_runner=cli_runner, test_path=test_path)
        self._test_application_compiled_output(test_path=test_path, cli_runner=cli_runner, dist_path=dist_path)
